...
const pageTitles: Record<string, string> = {
  ...
  "/dashboard/seller/fulfilment": "Fulfilment",
  "/dashboard/seller/fulfilment/inbound": "Inbound Shipments",
  "/dashboard/seller/fulfilment/inventory": "FBX Inventory",
  ...
  "/dashboard/admin/catalog/product-categories": "Product Categories",
  "/dashboard/admin/catalog/business-categories": "Business Categories",
  "/dashboard/admin/catalog/brands": "Brands",
  "/dashboard/admin/inventory": "Inventory Operations",
  "/dashboard/admin/orders": "Orders",
  "/dashboard/admin/payments": "Payments",
  "/dashboard/admin/commissions": "Commission Rules",
  "/dashboard/admin/coupons": "Coupons",
  "/dashboard/admin/shipping": "Shipping Operations",
  "/dashboard/admin/fulfilment": "Fulfilment Overview",
  "/dashboard/admin/fulfilment/warehouses": "Warehouses",
  "/dashboard/admin/fulfilment/inbound": "Inbound Shipments",
  "/dashboard/admin/fulfilment/picklists": "Pick Lists",
