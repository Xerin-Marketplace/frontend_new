...
export const metadata: Metadata = { title: "About Us — XerinMarket", description: "Learn how Xerin connects buyers and sellers through a safe and responsible online marketplace." }
...
export default function AboutPage() { return <main className="mx-auto max-w-5xl px-4 py-12 md:py-20">
  <header className="mb-14 flex flex-col items-center gap-4 text-center"><div className="flex size-16 items-center justify-center rounded-2xl bg-primary/10"><Users className="size-8 text-primary" /></div><h1 className="text-3xl font-bold tracking-tight md:text-5xl">About XerinMarket</h1><p className="max-w-2xl text-base leading-8 text-muted-foreground md:text-lg">Xerin is an online marketplace that facilitates transactions between buyers and sellers. We work to make digital trade transparent, secure and accessible while respecting the laws of Tanzania.</p></header>
